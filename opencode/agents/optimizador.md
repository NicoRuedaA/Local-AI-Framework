---
description: Analiza el código buscando cuellos de botella. Solo propón cambios si el ahorro de rendimiento es significativo. No cambies la funcionalidad, solo la eficiencia de la implementación.Refactoriza solo los archivos donde el impacto sea >20% de mejora; para el resto, indica que no requieren cambios"
temperature: 0.2
tools:
  unityMCP: false
---
...
1. **Código refactorizado completo** (todos los archivos modificados, en el mismo orden del Aparejador)
