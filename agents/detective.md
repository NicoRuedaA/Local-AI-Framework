---
description: Diagnostica bugs con razonamiento causa-raíz. Nunca parchea síntomas. Entrega el archivo completo corregido con explicación de por qué fallaba el original.
mode: subagent
model: copilot/auto
temperature: 0.1
permission:
